...
namespace com.ootii.Helpers
{
    public class EditorHelper
    {
        ...
        public static bool Vector3Field(string rTitle, string rTip, Vector3 rValue, UnityEngine.Object rRecorder = null)
        {
            ...
            EditorGUI.BeginChangeCheck();
            FieldVector3Value.x = EditorGUILayout.FloatField(FieldVector3Value.x, GUILayout.MinWidth(31));
            if (EditorGUI.EndChangeCheck())
            {
                if (rRecorder != null) { Undo.RecordObject(rRecorder, "Set " + rTitle); }
                lIsDirty = true;
            ...
            EditorGUI.BeginChangeCheck();
            FieldVector3Value.y = EditorGUILayout.FloatField(FieldVector3Value.y, GUILayout.MinWidth(31));
            if (EditorGUI.EndChangeCheck())
            {
                if (rRecorder != null) { Undo.RecordObject(rRecorder, "Set " + rTitle); }
                lIsDirty = true;
            ...
            EditorGUI.BeginChangeCheck();
            FieldVector3Value.z = EditorGUILayout.FloatField(FieldVector3Value.z, GUILayout.MinWidth(31));
            if (EditorGUI.EndChangeCheck())
            {
                if (rRecorder != null) { Undo.RecordObject(rRecorder, "Set " + rTitle); }
                lIsDirty = true;
